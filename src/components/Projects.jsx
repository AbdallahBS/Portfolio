...
const Projects = () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            liveUrl: 'https://www.kaggle.com/code/bensalemabdallah/house-price-prediction-in-tunisia',
            githubUrl: '#',
            featured: true,
        },
        {
        ...
        {
            id: 5,
            title: 'Mon PFE - Internship Finder',
            description: 'Mobile application that aggregates final year project (PFE) opportunities from companies across Tunisia, helping students easily find and access internship information.',
            image: monPfeImg,
            tags: ['Flutter', 'Mobile', 'Firebase'],
            liveUrl: '#',
            githubUrl: 'https://github.com/AbdallahBS/Mon-PFE',
            featured: true,
                ...
                <div className="project-modal" onClick={() => setShowModal(false)}>
                    <div className="project-modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="project-modal-body">
                            <div className="project-modal-message">
                                <p>
                                    👋 <strong>Hey! Thank you for your attention and time to see my projects.</strong>
                                </p>
                                <p>
                                    Currently, we are moving this project into the <strong>Universe Project</strong> to combine all services in one platform. However, I keep the code existing in my GitHub account to show you how I have structured the architecture of the application using <strong>Flutter</strong>.
                                </p>
                            </div>
